...
: ${AMENT_CURRENT_PREFIX:="/workspaces/solara_sim/dev_ws/install/solara_pkg"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/solara_pkg/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/solara_pkg/environment/path.sh"
